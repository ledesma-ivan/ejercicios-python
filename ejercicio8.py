...
promedio = suma / 10
print(
    f"La suma de los valores ingresados es: {suma}, y su promedio es {promedio}")
...
print(
    f"La cantidad de alumnos con notas mayores o iguales a 7 es: {cantidad_pro} y la cantidad de alumnos con notas menores a 7 es: {cantidad_no_pro}")
...
# En este caso no pide usar listas, si bien es una opcion viable habra que
...
print(
    f"La cantidad de triagulos que son equilateros, {equilátero}, y isosceles {isosceles}, y lo que son escaleno {escaleno}")
...
total_numeros_pares = sum(numeros_pares)

print("La cantidad de numeros positivos es: ", valores_positivos)
print("La cantidad de numeros negativos es: ", valores_negativos)
print("La cantidad de numeros multiplos de 15 es: ", multiplos_15)
print("La suma total de los numeros pares es: ", total_numeros_pares)
